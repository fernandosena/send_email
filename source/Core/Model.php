...
abstract class Model
{
     ...
     * @return Model|mixed
     */
    public function find(?string $terms = null, ?string $params = null, string $columns = "*", ?string $extra = null)
    {
        if ($terms) {
            $this->query = "SELECT {$columns} FROM {$this->entity} {$extra} WHERE {$terms}";
            parse_str($params, $this->params);
            return $this;
        }

        $this->query = "SELECT {$columns} FROM {$this->entity} {$extra}";
        return $this;
    }
